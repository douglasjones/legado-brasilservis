...
(function (k) {
    ...
    function Ea(a) {
        ...
        var m = k(h), p = h.style, t = k(a.nScrollFoot).children("div"), v = t.children("table"), x = k(a.nTHead),
            r = k(a.nTable), A = r[0], E = A.style, I = a.nTFoot ? k(a.nTFoot) : null, W = a.oBrowser,
    ...
    var u = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) aa(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    if (null === g.aoColumns) for (t = [], h = 0, l =
                        f.length; h < l; h++) t.push(null); else t = g.aoColumns;
                    h = 0;
        ...
        qb = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, ca = function (a) {
            ...
            if (c !== q) for (; e < f; e++) a[e] && a[e][b] && d.push(a[e][b][c]); else for (; e <
        ...
        pageButton: {
            _: function (a, b, c, d, e, f) {
                var g = a.oClasses, h = a.oLanguage.oPaginate, l = a.oLanguage.oAria.paginate || {}, n, m, p = 0,
                    t = function (x, r) {
                        var A, E = g.sPageButtonDisabled, I = function (B) {
