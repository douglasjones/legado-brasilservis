    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        init: function (e, i, s, l, o) {
            ...
            if (s.has("enable")) {
                ...
                }).extend({rateLimit: 100, notifyWhenChangesStop: !0}) : r(d)
            }
            if (s.has("disable")) {
                var u = s.get("disable");
                ...
                }).extend({rateLimit: 100, notifyWhenChangesStop: !0}) : r(!u)
            }
        ...
        defaults: {
            ...
            p.addClass(n), a.addClass(l), this.options.enableHTML ? p.html(" " + s) : p.html(" " + s);
            ...
            var e = "undefined" == typeof e ? !0 : e, s = t("li input[type='checkbox']:enabled", this.$ul),
