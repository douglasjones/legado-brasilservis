    ...
    w.Jconfirm.prototype = {
        ...
        _bindEvents: function() {
            ...
            this.$scrollPane.click(function(e) { // Ignore propagated clicks
                if (!that.boxClicked) { // Background clicked
                    ...
                    if (typeof that.backgroundDismiss === 'function') str = that.backgroundDismiss();
                    else
        ...
        _setButtons: function() {
            ...
            $.each(this.buttons, function(key, button) {
                ...
                that.buttons[key].action = button.action ||
                    function() {};
        ...
        setTitle: function(string, force) {
            ...
            if (typeof string !== 'undefined') if (typeof string === 'string') this.title = string;
        ...
        setIcon: function(iconClass, force) {
            ...
            if (typeof iconClass !== 'undefined') if (typeof iconClass === 'string') this.icon = iconClass;
