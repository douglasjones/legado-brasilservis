...
function fcCarregarGrid() {
    ...
    var v_url = routes_api("auditoria_categoria_tipos", "listarGrid", objParametros);
...
function fcExcluir(v_pk, v_ds_tipos_categoria){
    utilsJS.jqueryConfirm('Excluir ?', 'Deseja excluir o registro '+v_ds_tipos_categoria+'?',function(){
        if(v_pk != ""){
            ...
            var arrExcluir = carregarController("auditoria_categoria_tipos", "excluir", objParametros);   
...
function fcEditar(v_pk){
    ...
    sendPost('auditoria_categoria_tipos','cadForm' ,objParametros);
}

function fcIncluir(){
    sendPost('auditoria_categoria_tipos','cadForm',{});
}
