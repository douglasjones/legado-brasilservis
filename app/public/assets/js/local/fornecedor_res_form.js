...
function fcIncluir(){
    ...
    sendPost('fornecedor','cadForm',objParametros)

}

function fcExcluir(v_pk, v_ds_fornecedor){

    utilsJS.jqueryConfirm('Excluir?', 'Deseja excluir o registro '+v_ds_fornecedor+'?', function () {
        if(v_pk != ""){
            var objParametros = {
                "pk": v_pk
            };
...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("fornecedor", "listarGrid", objParametros);
