...
function fcIncluir(){
    var objParametros = {};
    sendPost('produtos','cadForm' ,objParametros);
}
...
function fcExcluir(v_pk, v_ds_produto){

    utilsJS.jqueryConfirm('Excluir?', 'Deseja excluir o registro '+v_ds_produto+'?', function () {
        if(v_pk != ""){
            var objParametros = {
                "pk": v_pk
            };

            var arrExcluir = carregarController("produto", "excluir", objParametros);
...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("produto", "listarGrid", objParametros);
    ...
    $('#tblResultado tbody').on('click', '.function_delete', function () {
        ...
        fcExcluir(data['t_pk'], data['t_ds_produto']);
    } );
