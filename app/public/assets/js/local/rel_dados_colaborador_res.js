...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("colaborador", "RelDadosColaborador", objParametros); 
    tblResultado = $("#tblResultado").DataTable({
        ...
        columns: [
            ...
            },
            {
             ...
             {
                mRender: function (data, type, full) {
                    return full['ds_regime_contratacao'];
                },
                'orderable': false,
                'searchable': false,
                width: '80px'
             ...
             {
                mRender: function (data, type, full) {
                    return full['ds_carga_horaria_semanal'];
                },
                'orderable': false,
                'searchable': false,
                width: '80px'
...
function fcCancelar(){
    var objParametros = {};
    sendPost('relatorio','pesqRelDadosColaborador' ,objParametros);
}
...
function fcExport(){
    ...
    hyperlink.download = "dados-colaborador.xls";
    hyperlink.href = link;
