...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("colaborador", "relatorioAniversariantesMes", objParametros);
    tblResultado = $("#tblResultado").DataTable({
        ...
        columns: [
            ...
            {
                mRender: function (data, type, full) {
                    return full['n_qtde_dias_semana'];
                },
                'orderable': false,
                'searchable': false,
                width: '80px'
...
function fcCancelar(){
    var objParametros = {};
    sendPost("colaborador", "receptivoRelAniversarianteMes", objParametros);
}
