...
function fcCarregarGridRes(){
    ...
    var v_url = routes_api("movimentacao_estoque", "RelatorioEstoque", objParametros); 
...
function fcCancelar(){
    var objParametros = {};
    sendPost('relatorio','pesqRelEstoqueSintetico' ,objParametros);
}
...
function fcExport(){
    ...
    hyperlink.download = "rel-estoque-sintetico.xls";
    hyperlink.href = link;
