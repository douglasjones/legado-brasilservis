...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("lancamento", "relDespesaPostoTrabalho", objParametros); 
    tblResultado = $("#tblResultado").DataTable({
        ...
        columns: [
            ...
            {
                mRender: function (data, type, full) {
                    return "R$ "+float2moeda(full['vl_despesa']);
                },
                'orderable': false,
                'searchable': false,
                width: '80px'
...
function fcCancelar(){
    var objParametros = {};
    sendPost('relatorio','pesqRelDespesaPostoTrabalho' ,objParametros);
}
...
function fcExport(){
    ...
    hyperlink.download = "relDespesaPostoTrabalho.xls";
    hyperlink.href = link;
