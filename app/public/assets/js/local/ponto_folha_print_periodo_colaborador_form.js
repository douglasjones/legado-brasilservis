function fcCarregar() {
    //if (pk > 0) {
        ...
        $.ajax({
                ...
                let arrCDados = carregarController("ponto_folha", "listarFolhaPorPeridoColaborador", params);
        
                if (arrCDados.status == true) {
                    for(p=0;p<arrCDados.data.length;p++){
                        // Define o objeto de parâmetros para cada colaborador
                        let objParametros = {
                            "pk": arrCDados.data[p]['ponto_folha_pk'],
                            "colaborador_pk": $('#colaborador_pk').val(), // Remove espaços extras se houver
                            "leads_pk": arrCDados.data[p]['leads_pk']
                        };
                                    ...
                                    $("#totalLinhas").val(arrCarregar.data[0].registrosfolha.length);
                                        ...
                                        if (typeof arrCarregar.data[0].registrosfolha[0].ponto_folha_registro_pk !== 'undefined') {
                                            for (i = 0; i < arrCarregar.data[0].registrosfolha.length; i++) {
                                                ...
                                                v_html += "   </td>";
                                                v_html += "   <td width='25' >";
                                                v_html += "<input type='hidden' "+ (ic_status == 1 ? " " : "") +"  id='hr_ini_expediente" + i + "' size='3' value='" + hr_ini_expediente + "' onkeypress='mascara(this,horamask)'>"+hr_ini_expediente;
                                                v_html += "   </td>";
                                                v_html += "   <td width='25' >";
                                                v_html += "<input type='hidden'  "+ (ic_status == 1 ? " " : "") +" id='hr_ini_intervalo" + i + "' size='3' value='" + hr_ini_intervalo + "' onkeypress='mascara(this,horamask)'>"+hr_ini_intervalo;
                                                v_html += "    </td>";
                                                v_html += "    <td width='25' >";
                                                v_html += "<input type='hidden'  "+ (ic_status == 1 ? " " : "") +" id='hr_fim_intervalo" + i + "' size='3' value='" + hr_fim_intervalo + "' onkeypress='mascara(this,horamask)'>"+hr_fim_intervalo;
                                                v_html += "    </td>";
                                
                                                v_html += "    <td width='25'>";
                                                v_html += "<input type='hidden' "+ (ic_status == 1 ? " " : "") +" id='hr_fim_expediente" + i + "' size='3' value='" + hr_fim_expediente + "' onkeypress='mascara(this,horamask)'>"+hr_fim_expediente;
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_trabalhadas" + i + "' size='3'  onkeypress='mascara(this,horamask)'>"+hr_trabalhadas+"</span>";
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_excedentes" + i + "' size='3' onkeypress='mascara(this,horamask)'>"+hr_excedentes;
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_faltantes" + i + "' size='3' onkeypress='mascara(this,horamask)'>"+hr_faltantes;
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                ...
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                v_html += "<span "+ (ic_status == 1 ? " " : "") +" id='hr_adicional_noturno" + i + "' size='3' onkeypress='mascara(this,horamask)'>"+hr_adicional_noturno;
                                                v_html += "    </td>";
                                                v_html += "    <td style=' text-align: center'>";
                                                v_html +=       obs;
                                                v_html += "    </td>";
                                        ...
                                        v_html += "    </td>";
                                        v_html += "    <td  style=' text-align: center'>";
                                        v_html += "       <span id='ht_total' name='ht_total' size='3' maxlength='8'  value='" + v_ht_total + "'>"+v_ht_total;
                                        v_html += "    </td>";
                                        v_html += "    <td  style=' text-align: center'>";
                                        v_html += "       <span id='he_total' name='he_total' size='3' maxlength='6' value='" + v_he_total + "' onkeypress='mascara(this,horamask)'>"+v_he_total;
                                        v_html += "    </td>";
                                        v_html += "    <td  style=' text-align: center'>";
                                        v_html += "       <span id='hf_total' name='hf_total' size='3' maxlength='6' value='" + v_hf_total + "'  onkeypress='mascara(this,horamask)'>"+v_hf_total;
                                        v_html += "    </td>";
                                        v_html += "    <td  style=' text-align: center'>";
                                        v_html += "      &nbsp;";
                                        v_html += "    </td>";
                                        ...
                                        v_html += "    </td>";
                                        v_html += "    <td  style=' text-align: center'>";
                                        v_html += "       <span id='an_total' name='an_total'  maxlength='6' value='" + v_an_total + "' onkeypress='mascara(this,horamask)'>"+converHrs(v_an_total);
                                        v_html += "    </td>";
