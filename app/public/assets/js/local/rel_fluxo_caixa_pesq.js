...
function fcCarregarGrid(){
    ...
    var contas_bancarias_pagamento_pk = $("#contas_bancarias_pagamento_pk").val();
    ...
    objParametros = {
        ...
        contas_bancarias_pagamento_pk:contas_bancarias_pagamento_pk,
    ...
    sendPost('relatorio', 'receptivoFluxoCaixa',objParametros);
}
...
function fcListarContaBancariaPagamento(){
    ...
    carregarComboAjax($("#contas_bancarias_pagamento_pk"), arrCarregar, " ", "pk", "ds_conta");
}
...
$(document).ready(function(){    
    ...
    fcListarContaBancariaPagamento();
    $('#tipos_operacao_pk_receita').select2();
    $('#contas_bancarias_pk').select2();
    $('#contas_bancarias_pagamento_pk').select2();
    $('#empresas_pk').select2();
    $('#grupo_leancamento_pk').select2();
    $('#usuario_cadastro_pk').select2();
