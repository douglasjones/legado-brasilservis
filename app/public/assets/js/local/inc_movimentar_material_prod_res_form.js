        ...
        columns: [
            ...
            },
            {
                mRender: function (data, type, full) {
                    ...
                    var buttonPainel = '<a  class="btn btn-sm function_painel" style="margin-right: 12px;"><i class="bi bi-pencil-square"></i></a>&nbsp;';
                    var buttonDelete = '<a  class="btn btn-sm function_delete"  style="margin-right: 12px;"><i class="bi bi-x-circle"></i></a>&nbsp;';
            ...
            columns: [
                ...
                },
                {
                    mRender: function (data, type, full) {
                        ...
                        var buttonDelete = '<a  class="btn btn-sm" onclick="fcExcluirMaterial('+full['pk']+')"  style="margin-right: 12px;"><i class="fa fa-trash-alt"></i></a>&nbsp;';
                        return buttonDelete;
                    },
                    'orderable': false,
                    'searchable': false,
    ...
    if ($("#qtde_materias").val() > 0) {
        ...
        if (arrCarregar1.data.length > 0) {
            ...
            for (i = 0; i < arrCarregar1.data.length; i++) {
                ...
                tblMaterial.row.add( [
                    "<td><input type='hidden' id='movimentacao_estoquePk[]' value=''></td>",
