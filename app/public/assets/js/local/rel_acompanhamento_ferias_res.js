...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("colaborador", "RelatorioAcompanhamentoFerias", objParametros); 
...
function fcCancelar(){
    var objParametros = {};
    sendPost("relatorio", "pesqRelAcompanhamentoFerias",objParametros);
}
