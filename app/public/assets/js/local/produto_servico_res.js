...
function fcIncluir(){
    ...
    sendPost('servico','cadForm',objParametros);
...
function fcExcluir(v_pk, v_ds_produto){
    ...
    utilsJS.jqueryConfirm('Excluir?', 'Deseja excluir o registro '+v_pk+'?', function () {
        if(v_pk != ""){
            ...
            var arrExcluir = carregarController("servico", "excluir", objParametros);   
...
function fcCarregarGrid(){
    ...
    var v_url = routes_api("servico", "listarGrid", objParametros);
