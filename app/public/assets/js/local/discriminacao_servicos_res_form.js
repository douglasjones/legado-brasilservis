...
function fcIncluir(){
    ...
    sendPost('discriminacao_servicos','cadForm',objParametros)    
}
...
function fcCarregarGrid(){
    var objParametros = {
        "ds_discriminacao_servico": $("#ds_discriminacao_servico").val()
    };     
    
    var v_url = routes_api("discriminacao_servicos", "listarGrid", objParametros);
    ...
    //Trata a tabela
        tblResultado = $('#tblResultado').DataTable({
            ...
            columns: [
                ...
                {
                    mRender: function (data, type, full) {
                        return full['t_ds_discriminacao_servico'];
                    },
                    'orderable': true,
                    'searchable': false,
